    ...
    context 'with a api_key with harvester role' do
      ...
      describe 'POST create' do
        it 'creates a new source' do
          expect do
            post :create, params: { partner_id: partner, source: attributes_for(:source), api_key: harvester.api_key }
        ...
        context 'source already exists' do
          it 'updates the source' do
            source = partner.sources.create(attributes_for(:source, source_id: 'source_1'))
      ...
      describe 'GET "show"' do
        ...
        it 'assigns the source' do
          get :show, params: { id: source.id, api_key: harvester.api_key }
      ...
      describe 'GET "link_check_records"' do
        ...
        let(:source) { build(:source, source_id: 'source_name') }
        ...
        it 'should call the random records methid for source with 4' do
          ...
          get :link_check_records, params: { id: source.id, api_key: harvester.api_key }
        end
    ...
    context 'with api_key without harvester role' do
      ...
      describe 'GET link_check_records' do
        it 'returns unauthorized' do
          get :link_check_records, params: { id: 1, api_key: admin.api_key }
      ...
      describe 'GET reindex' do
        it 'returns unauthorized' do
          get :reindex, params: { id: 1, date: Time.now.utc, api_key: admin.api_key }
      ...
      describe 'PUT update' do
        it 'returns unauthorized' do
          put :update, params: { id: 1, source: { status: 'suppressed' }, api_key: admin.api_key }
      ...
      describe 'GET index' do
        it 'returns unauthorized' do
          get :index, params: { api_key: admin.api_key }
      ...
      describe 'GET "show"' do
        it 'returns unauthorized' do
          get :show, params: { id: 1, api_key: admin.api_key }
      ...
      describe 'POST "create"' do
        it 'returns unauthorized' do
          post :create, params: { partner_id: 1, source: attributes_for(:source), api_key: admin.api_key }
