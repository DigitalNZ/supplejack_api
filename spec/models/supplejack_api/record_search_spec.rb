  ...
  describe RecordSearch do
    ...
    describe '#execute_solr_search' do
      ...
      it 'should add spellcheck if suggest parameter is true' do
        ...
        @search.execute_solr_search
        @session.searches.last.last.instance_variable_get(:@query).to_params[:spellcheck].should be_truthy
        @session.searches.last.last.instance_variable_get(:@query).to_params['spellcheck.collate'].should be_truthy
        @session.searches.last.last.instance_variable_get(:@query).to_params['spellcheck.onlyMorePopular'].should be_truthy
      end
