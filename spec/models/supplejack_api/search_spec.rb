...
module SupplejackApi
  describe Search do
    ...
    describe ".role_collection_restrictions" do
      ...
      let(:developer_restriction) { double(:developer_restriction, record_restrictions: {is_catalog_record: true}) }
      ...
      it "should return nil when no role restrictions are defined in the Schema" do
        Search.role_collection_restrictions(developer).should eq({is_catalog_record: true})
      end
    end
    ...
    describe "#execute_solr_search" do
      ...
      it "doesn't downcase when targeting a specific field" do
        @search.options[:text] = "content_partner_sm:\"National Library of New Zealand\""
        @search.execute_solr_search
        @session.should have_search_params(:keywords, "content_partner_sm:\"National Library of New Zealand\"")
      end
