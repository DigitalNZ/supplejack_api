  ...
  describe IndexRemainingRecordsInQueue do
    ...
    context 'when indexing array of SupplejackApi.config.record_class' do
      before do
        ...
        allow_any_instance_of(RecordRedisQueue).to receive(:records_to_index).and_return(create_list(:record,10))
    ...
    context 'when removing array of SupplejackApi.config.record_class' do
      before do
        ...
        allow_any_instance_of(RecordRedisQueue).to receive(:records_to_remove).and_return(create_list(:record,10))
